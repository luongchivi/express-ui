...
const Footer = () => {
    return (
        <div className="w-full">
            <div className="h-[103px] bg-main w-full flex-col flex items-center justify-center">
            ...
            <div className="h-[407px] bg-gray-900 w-full flex items-center justify-center text-white text-[13px]">
                <div className="w-main flex">
                    <div className="flex-2 flex flex-col gap-2">
                        <h3 className="mb-[20px] text-[15px] font-medium border-l border-main pl-[15px]">ABOUT US</h3>
                        <span>
                            <span>Address: </span>
                    ...
                    <div className="flex-1 flex flex-col gap-2">
                        <h3 className="mb-[20px] text-[15px] font-medium border-l border-main pl-[15px]">INFORMATION</h3>
                    ...
                    <div className="flex-1 flex flex-col gap-2">
                        <h3 className="mb-[20px] text-[15px] font-medium border-l border-main pl-[15px]">WHO WE ARE</h3>
                        <span>Help</span>
                    ...
                    <div className="flex-1 flex flex-col gap-2">
                        <h3 className="mb-[20px] text-[15px] font-medium border-l border-main pl-[15px]">#DIGITALWORLDSTORE</h3>
                    </div>
                </div>
            </div>
        </div>
